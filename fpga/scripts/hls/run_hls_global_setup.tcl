...
# 08102020 Renaming output files
#solution options set Output/PackageOutput true
#solution options set Output/PackageStaticFiles true
#solution options set Output/PrefixStaticFiles true

#required for catapult 10.6
set QUESTA_SIM_HOME $env(QUESTA_HOME)
solution options set /Flows/QuestaSIM/Path ${QUESTA_SIM_HOME}/bin
...
#solution options set /Flows/SCVerify/USE_QUESTASIM true
...
#solution options set Flows/VCS/VCSELAB_OPTS {-sysc=blocksync -debug_all -timescale=1ps/1ps}
...
# Extract DSP from MAC to map to FPGA DSP blocks
directive set -DSP_EXTRACTION yes
directive set -DSP_EXTRACTION_UNFOLD_MAC yes
