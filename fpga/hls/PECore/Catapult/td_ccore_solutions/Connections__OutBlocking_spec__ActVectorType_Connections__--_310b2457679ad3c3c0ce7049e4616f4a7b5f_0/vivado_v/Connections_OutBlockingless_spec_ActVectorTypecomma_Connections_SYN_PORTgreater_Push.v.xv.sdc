...
create_clock -name ccs_MIO_clk -period 6.0 -waveform { 0.0 3.0 } [get_ports {ccs_MIO_clk}]
set_clock_uncertainty 0.0 [get_clocks {ccs_MIO_clk}]

create_clock -name virtual_io_clk -period 6.0
...
set_max_delay 6.0 -from [all_inputs] -to [all_outputs]
